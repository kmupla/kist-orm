...
class DbOperationsTest {
    private val underTest = _root_ide_package_.io.github.kmupla.kist.DbOperations
...
//        every { cursor.close() } returns Unit
    ...
    fun `insert should insert data and return a new id`() {
        val person = _root_ide_package_.io.github.kmupla.kist.Person(name = "John Doe", age = 30)
        val metadata = _root_ide_package_.io.github.kmupla.kist.PersonMetadata()
    ...
    fun `update should modify existing data`() {
        val person = _root_ide_package_.io.github.kmupla.kist.Person(id = 1L, name = "Jane Doe", age = 26)
        val metadata = _root_ide_package_.io.github.kmupla.kist.PersonMetadata()
    ...
    fun `findAll should retrieve all records`() {
        ...
        val people = underTest.findAll(connection, metadata, _root_ide_package_.io.github.kmupla.kist.Person::class)
    ...
    fun `findById should retrieve a single record`() {
        ...
        val person = underTest.findById(connection, metadata, _root_ide_package_.io.github.kmupla.kist.Person::class, 1L)
...
private class PersonMetadata : io.github.kmupla.kist.EntityMetadata<io.github.kmupla.kist.Person> {
    override val tableName: String = "person"
    override val keyField: String = "id"
    override val fieldMetadata: List<io.github.kmupla.kist.FieldMetadata> = listOf(
    ...
    override fun bindFields(source: io.github.kmupla.kist.Person, statement: Statement, fieldIndexMap: Map<String, Int>) {
    ...
    override fun getId(source: io.github.kmupla.kist.Person): Any? {
        return source.id
    }

    override fun create(cursor: Cursor): io.github.kmupla.kist.Person {
        return _root_ide_package_.io.github.kmupla.kist.Person(
            id = cursor.getLong(0),
